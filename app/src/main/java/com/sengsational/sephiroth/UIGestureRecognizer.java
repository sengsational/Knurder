...
public abstract class UIGestureRecognizer implements OnGestureRecognizerStateChangeListener {
    ...
    static final long LONG_PRESS_TIMEOUT = ViewConfiguration.getLongPressTimeout() * 2; // DRS 20170408 - Double the normal long press timeout

...
public final class OcrCaptureActivity extends AppCompatActivity {
    ...
    private String mFlavor = "tapMenu";// "tapMenu" or "newArrivals"
    ...
    public void onCreate(Bundle bundle) {
        ...
        boolean useFlash = getIntent().getBooleanExtra("lightbulb", true);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        mDetectorProcessor = new OcrDetectorProcessor(mGraphicOverlay, mFlavor, context);
        ...
        mCameraSource =
                new com.sengsational.ocrreader.camera.CameraSource.Builder(getApplicationContext(), textRecognizer)
                    .setFacing(com.sengsational.ocrreader.camera.CameraSource.CAMERA_FACING_BACK)
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        builder.setTitle("Didn\'t Get Access to Camera")

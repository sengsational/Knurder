 ...
 * overlay view.
 */
public class OcrGraphic extends com.sengsational.ocrreader.camera.GraphicOverlay.Graphic {
    ...
    OcrGraphic(com.sengsational.ocrreader.camera.GraphicOverlay overlay, TextBlock text) {
        super(overlay);

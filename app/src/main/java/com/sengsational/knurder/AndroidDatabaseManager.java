package com.sengsational.knurder;//add your package name here example: package com.example.dbm;

/**
 * This is a debugging tool.  May be eliminated from the project after development completed.
 */
...
// all global variables
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
		dbm = new UfoDatabaseAdapter(AndroidDatabaseManager.this);
